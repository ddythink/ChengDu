    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spider_from', models.IntegerField(verbose_name='\u6765\u6e90', choices=[(1, '\u4e13\u4e1a\u4f1a\u5c55\u7f51'), (2, '\u4e92\u8054\u7f51'), (0, '\u5176\u4ed6')])),
                ('crawler_time', models.DateTimeField(verbose_name='\u722c\u53d6\u65f6\u95f4')),
            ],
            options={
                'verbose_name': '\u6587\u7ae0',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('over_3w_area', models.FloatField(verbose_name='3\u4e07\u7c73\u4ee5\u4e0a\u5c55\u89c8\u9762\u79ef\u548c')),
            ],
            options={
                'verbose_name': '\u57ce\u5e02\u6570\u636e',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_num', models.IntegerField(verbose_name='\u529e\u5c55\u603b\u6570\u91cf')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('locate', models.IntegerField(default=0, verbose_name='\u4f1a\u5c55\u5c5e\u5730', choices=[(0, '\u6210\u90fd'), (1, '\u5e7f\u5dde'), (2, '\u4e0a\u6d77'), (3, '\u5317\u4eac'), (4, '\u6df1\u5733'), (5, '\u5929\u6d25'), (6, '\u91cd\u5e86'), (7, '\u6b66\u6c49'), (8, '\u5357\u4eac')])),
                ('exhibition_type', models.CharField(max_length=256, null=True, verbose_name='\u4f1a\u5c55\u7c7b\u578b', blank=True)),
                ...
                ('area', models.IntegerField(null=True, verbose_name='\u6bdb\u9762\u79ef', blank=True)),
                ('com_num_local', models.IntegerField(default=0, null=True, verbose_name='\u672c\u5730\u4f01\u4e1a\u6570\u91cf', blank=True)),
                ('com_num_provin', models.IntegerField(default=0, null=True, verbose_name='\u5916\u7701\u4f01\u4e1a\u6570\u91cf', blank=True)),
                ('com_num_broad', models.IntegerField(default=0, null=True, verbose_name='\u56fd\u5916\u4f01\u4e1a\u6570\u91cf', blank=True)),
                ('peo_num_local', models.IntegerField(default=0, null=True, verbose_name='\u672c\u5730\u89c2\u4f17\u6570\u91cf', blank=True)),
                ('peo_num_provin', models.IntegerField(default=0, null=True, verbose_name='\u5916\u7701\u89c2\u4f17\u6570\u91cf', blank=True)),
                ('peo_num_broad', models.IntegerField(default=0, null=True, verbose_name='\u56fd\u5916\u89c2\u4f17\u6570\u91cf', blank=True)),
                ('industry', models.CharField(max_length=256, null=True, verbose_name='\u6d89\u53ca\u4e3b\u8981\u884c\u4e1a', blank=True)),
                ('period', models.IntegerField(verbose_name='\u9879\u76ee\u8fd0\u884c\u65f6\u95f4')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zero', models.TextField(default='\u8fd9\u91cc\u7528\u4e8e\u8f93\u5165\u62a5\u544a\u7684\u63cf\u8ff0\u4fe1\u606f', null=True, verbose_name='\u5f00\u5934\u63cf\u8ff0', blank=True)),
                ('one', models.TextField(default='\u8fd9\u91cc\u7528\u4e8e\u8f93\u5165\u62a5\u544a\u7684\u63cf\u8ff0\u4fe1\u606f', null=True, verbose_name='\u89c4\u6a21\u8bc4\u4f30', blank=True)),
                ('two', models.TextField(default='\u8fd9\u91cc\u7528\u4e8e\u8f93\u5165\u62a5\u544a\u7684\u63cf\u8ff0\u4fe1\u606f', null=True, verbose_name='\u96f7\u8fbe\u56fe\u63cf\u8ff0', blank=True)),
                ('three', models.TextField(default='\u8fd9\u91cc\u7528\u4e8e\u8f93\u5165\u62a5\u544a\u7684\u63cf\u8ff0\u4fe1\u606f', null=True, verbose_name='\u62a5\u9053\u8d8b\u52bf\u63cf\u8ff0', blank=True)),
                ('four', models.TextField(default='\u8fd9\u91cc\u7528\u4e8e\u8f93\u5165\u62a5\u544a\u7684\u63cf\u8ff0\u4fe1\u606f', null=True, verbose_name='\u53d1\u5e03\u8d8b\u52bf\u63cf\u8ff0', blank=True)),
                ('five', models.TextField(default='\u8fd9\u91cc\u7528\u4e8e\u8f93\u5165\u62a5\u544a\u7684\u63cf\u8ff0\u4fe1\u606f', null=True, verbose_name='\u8f6c\u53d1\u63cf\u8ff0', blank=True)),
                ('six', models.TextField(default='\u8fd9\u91cc\u7528\u4e8e\u8f93\u5165\u62a5\u544a\u7684\u63cf\u8ff0\u4fe1\u606f', null=True, verbose_name='\u4f20\u64ad\u5f71\u54cd\u529b\u63cf\u8ff0', blank=True)),
                ('seven', models.TextField(default='\u8fd9\u91cc\u7528\u4e8e\u8f93\u5165\u62a5\u544a\u7684\u63cf\u8ff0\u4fe1\u606f', null=True, verbose_name='\u5a92\u4f53\u5730\u57df\u5206\u5e03\u63cf\u8ff0', blank=True)),
                ('eight', models.TextField(default='\u8fd9\u91cc\u7528\u4e8e\u8f93\u5165\u62a5\u544a\u7684\u63cf\u8ff0\u4fe1\u606f', null=True, verbose_name='\u5a92\u4f53\u7ed3\u6784\u7ec4\u6210\u63cf\u8ff0', blank=True)),
            ],
            options={
                'verbose_name': '\u62a5\u544a',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('locate', models.CharField(max_length=256, verbose_name='\u6240\u5c5e\u5730\u540d')),
                ('nature', models.SmallIntegerField(verbose_name='\u7f51\u7ad9\u7c7b\u522b', choices=[(1, '\u5b98\u7f51'), (2, '\u4f1a\u5c55\u4e13\u4e1a\u7c7b\u7f51'), (3, '\u666e\u901a\u5a92\u4f53\u7c7b\u7f51'), (4, '\u5927\u578b\u65b0\u95fb\u7f51')])),
                ('ip', models.IntegerField(verbose_name='IP\u91cf')),
                ('pv', models.IntegerField(verbose_name='PV\u91cf')),
                ('flag', models.SmallIntegerField(verbose_name='\u6570\u636e\u72b6\u6001', choices=[(1, '\u81ea\u52a8\u83b7\u5f97'), (2, '\u5f85\u7ea0\u6b63'), (3, '\u5df2\u786e\u5b9a')])),
            ],
            options={
                'verbose_name': '\u5c5e\u6027',
